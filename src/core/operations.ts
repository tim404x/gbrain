...
async function runAutoLink(
  ...
  // Passing opts?.sourceId scopes the fuzzy fallback to the same source the
  // put_page is targeting — without it, cross-source slug suggestions get
  // silently dropped at the FK filter and the link looks like it failed to
  // resolve. Twin of #1436's `tryFuzzyMatch` fix.
